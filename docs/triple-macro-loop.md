...
**Live mapping (2026-09-20 ~04:23 CT):** **A = S1** walls-swing (**LR=1e-4** cold restart @08:46Z — hang_align **−0.97→−0.059 @u60**, ent~2.24↑ @u62, policy_loss sane, no 2nd NaN); **B = H1** walls-hold (tight `INIT_NOISE=0.05`, live ENT=0.02 **dead≈−0.42 @u307**, **ENT=0.035 staged** for natural restart ~05:14 CT); **C = H1-var** walls-hold (ENT=0.05 live, ent~1.36, **nt still ~0.046** — ENT null for hold). Combo mush retired. X1 handoff_eval staged. `VEL_COST=0.015` + B `ENT=0.035` apply on **natural restart only**. Do not relaunch wide void TQC. **Do not** put AR-EAPO MaxEnt on H1 (MaxEnt fights upright stay — 2503.15290; Entropy Bifurcation / soft-Q mislead — 2506.05615).
