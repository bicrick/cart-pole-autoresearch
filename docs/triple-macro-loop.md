...
Last updated: 2026-09-20 ~05:21 CT
...
**Live mapping (2026-09-20 ~05:21 CT):** **A = S1** walls-swing (**LR=1e-4** @08:46Z — hang_align **−0.97→−0.037 @u170**, hang_at_goal~0.002, nt~0.043 nt_align~0.227, ent~1.68 @u171, policy_loss **−0.018** — **inside prior NaN window u150–228, still clean**); **B = H1** walls-hold **ENT=0.035 + VEL_COST=0.015** pid **158009** @~u10 (ent **−0.80→−0.84↓** still diving from dead-σ ckpt; nt @u1 ~0.050 — **babysit to ~u80**); **C = H1-var** walls-hold — prior stretch ended u400 nt~0.047 ent~1.15; **natural restart LIVE** pid **158583** @10:22Z (ENT=0.05 + VEL_COST=0.015). Combo mush retired. X1 handoff_eval staged. Do not relaunch wide void TQC. **Do not** put AR-EAPO MaxEnt on H1 (MaxEnt fights upright stay — 2503.15290; Entropy Bifurcation / soft-Q mislead — 2506.05615).
...
- **Live (2026-09-20 ~05:21 CT):** VM `cartpole-train-od` RUNNING us-east1-b (L4 ~99%/15.6GB, uptime ~2d). TB http://34.148.138.48:6006/ HTTP 200. Watchers continue-a/b/c.
  - **A = S1 walls-swing** — prior NaN @u228 quarantined; **LR=1e-4 pid 153439** @08:46Z. ~**u171** hang_align/UUU **−0.97→−0.037** (slight wobble vs −0.009@u150), hang_at_goal~0.002, nt~0.043 nt_align~0.227, ent **~1.68**, policy_loss **−0.018** — **inside NaN window ~u150–228; still clean**. Marker `.triple-a-s1-walls-v1`.
  - **B = H1 walls-hold (tight)** — **ENT=0.035 + VEL_COST=0.015 LIVE** pid **158009** / w **147599** (~**u10**, run `…-ent035-…`). Marker `.triple-b-h1-noise05-v1`. ent **−0.80→−0.84↓** (still diving from dead-σ ckpt); nt @u1 **~0.050**. **Do not mid-kill** — give ENT035 until ~u80.
  - **C = H1-var walls-hold** — prior stretch ended **u400** nt~0.047 ent~1.15; **natural restart LIVE** pid **158583** @10:22Z / w **146717** (ENT=0.05 + VEL_COST=0.015, INIT_NOISE=0.08). Marker `.triple-c-h1var-walls-v1`. Fresh stretch — leave alone.
- **X1 handoff:** staged. Smoke deferred until H1 nt≳0.2 (B/C still ~0.05). Soft-land VEL_COST live on B + now on C continue.
- **Diagnosis / actions this fire:** A hang wobble near 0 + policy_loss healthy inside NaN window — leave alone. B ENT035 only @u10, σ still diving — leave alone (babysit to u80). C stretch ended; **confirmed natural H1-var continue landed**. OOB=0. No code.
